...
Write a program that prints all possible combinations of two two-digit numbers.program will assign a random number to the variable n each time it is executed. Complete 
